...
// TODO: RegistrationRequest is the first message of the registration flow
...
func (r *RegistrationRequest) Serialize() []byte {
	...
	return encoding.Concat(r.BlindedMessage.Encode(), r.UserName)
}

// TODO: RegistrationResponse
...
// Serialize returns the byte encoding of RegistrationRecord.
//func (r *RegistrationRecord) Deserialize() []byte {
//	return encoding.Concat3(r.PublicKey.Encode(), r.MaskingKey, r.Envelope)
//}
